...
url = 'https://api.github.com/search/repositories?q=language:JavaScript&sort=estrellas'
...
mi_disposicion = {
    'title': 'Repositorios JavaScript mejor valorados en GitHub',
    'titlefont': {'size': 28},
    'xaxis': {
        'title': 'Repositorio',
        'titlefont': {'size': 24},
...
offline.plot(fig, filename='reposiorios_JavaScript.html')
