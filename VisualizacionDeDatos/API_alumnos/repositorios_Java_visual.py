...
url = 'https://api.github.com/search/repositories?q=language:Java&sort=estrellas'
...
mi_disposicion = {
    'title': 'Repositorios Java mejor valorados en GitHub',
    'titlefont': {'size': 28},
    'xaxis': {
        'title': 'Repositorio',
        'titlefont': {'size': 24},
...
offline.plot(fig, filename='reposiorios_Java.html')
