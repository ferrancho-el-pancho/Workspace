...
url = 'https://api.github.com/search/repositories?q=language:Ruby&sort=estrellas'
...
mi_disposicion = {
    'title': 'Repositorios Ruby mejor valorados en GitHub',
    'titlefont': {'size': 28},
    'xaxis': {
        'title': 'Repositorio',
        'titlefont': {'size': 24},
...
offline.plot(fig, filename='reposiorios_Ruby.html')
